...
class TransitionProcessor:
    ...
    @staticmethod
    def apply_transition_in_filter(video_filters: list, audio_filters: list, transition_type: str, duration: float) -> None:
    ...
    @staticmethod
    def apply_transition_out_filter(video_filters: list, audio_filters: list, transition_type: str, duration: float, start_time: float) -> None:
        if transition_type == "fade":
